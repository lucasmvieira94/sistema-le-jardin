...
import { ArrowLeft, Clock, MessageSquare, AlertTriangle, CheckCircle, Filter, Eye } from 'lucide-react';
      ...
      <div className="container mx-auto max-w-4xl">
        <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-xl mb-4">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className="text-lg sm:text-xl font-bold text-gray-900">Painel de Intercorrências</h1>
              <p className="text-sm text-muted-foreground">Gestão e acompanhamento — {funcionarioNome}</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
            ...
            <Card className="bg-yellow-50">
              <CardContent className="p-3 text-center">
                <p className="text-2xl font-bold text-yellow-700">{counts.abertas}</p>
                <p className="text-xs text-yellow-600">Abertas</p>
              </CardContent>
            </Card>
            <Card className="bg-red-50">
              <CardContent className="p-3 text-center">
                <p className="text-2xl font-bold text-red-700">{counts.criticas}</p>
                <p className="text-xs text-red-600">Críticas</p>
              </CardContent>
            </Card>
            <Card className="bg-green-50">
              <CardContent className="p-3 text-center">
                <p className="text-2xl font-bold text-green-700">{counts.resolvidas}</p>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-2">
                    ...
                    {selectedItem.residentes && ` | Residente: ${(selectedItem.residentes as any).nome}`}
                  </p>
                  <p className="text-xs text-muted-foreground">
                    Data: {new Date(selectedItem.created_at).toLocaleDateString('pt-BR', { day: '2-digit', month: '2-digit', year: 'numeric', hour: '2-digit', minute: '2-digit' })}
                  </p>
                </div>
