    ...
    const fetchCompanyConfig = async () => {
      try {
        const {
          data,
          error
        } = await supabase.from('configuracoes_empresa').select('nome_empresa, logo_url').single();
        if (error) {
    ...
    return <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
          <div className="text-center mb-8">
            {companyLogo ? <img src={companyLogo} alt="Logo da empresa" className="w-80 h-80 mx-auto mb-4 object-contain" /> : <img src={careLogo} alt="Logo da empresa" className="w-80 h-80 mx-auto mb-4 object-contain" />}
      ...
      <div className="container mx-auto max-w-2xl">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-xl mb-6">
          <div className="text-center space-y-4">
            <div className="flex items-center justify-center gap-3">
              {companyLogo ? <img src={companyLogo} alt="Logo da empresa" className="w-40 h-40 object-contain" /> : <img src={careLogo} alt="Logo da empresa" className="w-40 h-40 object-contain" />}
              <div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {/* Registro de Ponto */}
            <Card className="cursor-pointer hover:shadow-lg transition-all duration-200 hover:scale-105 border-2 hover:border-green-300" onClick={navigateToRegistroPonto}>
              ...
              <CardContent className="text-center">
                ...
                <Button className="w-full bg-green-600 hover:bg-green-700" onClick={navigateToRegistroPonto}>
                  Acessar Registro
                </Button>
              </CardContent>
            </Card>
            ...
            <Card className="cursor-pointer hover:shadow-lg transition-all duration-200 hover:scale-105 border-2 hover:border-blue-300" onClick={navigateToProntuario}>
              <CardHeader className="text-center pb-4">
              ...
              <CardContent className="text-center">
                ...
                <Button className="w-full bg-blue-600 hover:bg-blue-700" onClick={navigateToProntuario}>
                  Acessar Prontuário
                </Button>
              </CardContent>
            </Card>
          ...
          <div className="text-center mt-8 space-y-4">
            ...
            <div className="text-center">
              <Button onClick={navigateToAuth} className="px-8 bg-primary hover:bg-primary/90">
