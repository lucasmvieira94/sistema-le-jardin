...
BEGIN
    SELECT 
        ...
        COALESCE(e.intervalo_minutos, 60) AS intervalo_minutos
        ...
        ELSIF registro_record.entrada IS NOT NULL AND registro_record.saida IS NOT NULL THEN
            BEGIN
                ...
                ELSIF registro_record.intervalos_pausas IS NOT NULL
                    ...
                    -- minutos excedentes ao intervalo previsto na escala
                    IF pausas_total > make_interval(mins => funcionario_record.intervalo_minutos) THEN
                        excedente := pausas_total - make_interval(mins => funcionario_record.intervalo_minutos);
                    END IF;
                ELSE
            ...
            BEGIN
                SELECT COALESCE(public.calcular_horas_extras_diurnas(
                    ...
                    funcionario_record.escala_entrada, funcionario_record.escala_saida), interval '0')
                INTO extras_int;

                -- abate os minutos excedentes de intervalo das horas extras diurnas
