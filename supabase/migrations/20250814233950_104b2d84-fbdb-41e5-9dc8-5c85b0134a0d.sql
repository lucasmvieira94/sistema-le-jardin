-- Atualizar função preencher_horarios_por_escala para usar jornada_trabalho
...
BEGIN
  ...
  -- Determinar o número de dias do ciclo baseado na jornada de trabalho
  CASE 
    ...
    ELSE v_total_dias_escala := 7; -- Padrão para escalas semanais
  END CASE;
  ...
  WHILE v_data_atual <= p_data_fim LOOP
    ...
    ELSE
      -- Para escalas semanais tradicionais baseadas em dias da semana
      IF (
