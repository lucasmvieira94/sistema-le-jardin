-- Garantir que a extensão pgcrypto está corretamente instalada
CREATE EXTENSION IF NOT EXISTS pgcrypto;

-- Recriar função SEM prefixo de schema nas funções da extensão
...
DECLARE
  code_hash TEXT;
BEGIN
  -- Gerar hash - deixar PostgreSQL encontrar as funções no search_path
