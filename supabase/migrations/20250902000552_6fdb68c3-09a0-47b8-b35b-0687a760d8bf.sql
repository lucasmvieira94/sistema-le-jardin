-- Corrigir fuso horário para usar timezone do Brasil (America/Sao_Paulo)
-- Primeiro remover funções existentes e recriar com timezone correto

-- Remover funções existentes
DROP FUNCTION IF EXISTS public.iniciar_prontuario_diario(uuid, uuid);
DROP FUNCTION IF EXISTS public.redefinir_prontuarios_com_horario();
DROP FUNCTION IF EXISTS public.verificar_prontuario_diario_existente(uuid);
DROP FUNCTION IF EXISTS public.criar_ciclo_prontuario_diario();

-- Recriar função verificar_prontuario_diario_existente com timezone do Brasil
...
-- Recriar função iniciar_prontuario_diario com timezone do Brasil
...
-- Recriar função criar_ciclo_prontuario_diario com timezone do Brasil
...
-- Recriar função redefinir_prontuarios_com_horario com timezone do Brasil
