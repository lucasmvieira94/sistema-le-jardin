...
INSERT INTO auth.identities (
  ...
  gen_random_uuid(),
  (SELECT id FROM auth.users WHERE email = 'admin@senexcare.com.br'),
  format('{"sub": "%s", "email": "%s"}', (SELECT id FROM auth.users WHERE email = 'admin@senexcare.com.br'), 'admin@senexcare.com.br')::jsonb,
  'email',
  NOW(),
  NOW(),
  NOW()
